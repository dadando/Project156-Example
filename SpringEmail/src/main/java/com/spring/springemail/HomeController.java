...
public class HomeController {
	...
	public ModelAndView mailSending(HttpServletRequest request,String e_mail,
		...
		//String setfrom = "gmail 이메일 주소"; //Gmail 사용시
		//String setfrom = "daum 이메일 주소"; //daum 사용시
		String setfrom = "dadando@naver.com";	//네이버 사용시
	...
	//이메일로 받은 인증번호를 입력하고 전송 버튼을 누르면 맵핑이되는 메소드.
	...
	public ModelAndView join_injeung(@RequestParam(value="email_injeung")
		...
		String num,HttpServletResponse response)throws IOException{
